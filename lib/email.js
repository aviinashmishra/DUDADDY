  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #1a1a1a; color: #ffffff; padding: 20px;">
        ...
        <p style="color: #6b7280; font-size: 12px;">DuDaddy - Premium Products</p>
      </div>
    `,
  }
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #1a1a1a; color: #ffffff; padding: 20px;">
        ...
        <p style="color: #d1d5db;">Thank you for joining DuDaddy - your trusted source for premium products.</p>
        ...
        <p style="color: #d1d5db;">Start shopping now and discover quality products!</p>
        <hr style="margin: 30px 0; border: none; border-top: 1px solid #374151;">
        <p style="color: #6b7280; font-size: 12px;">DuDaddy - Premium Products</p>
      </div>
    `,
